...
echo "INFO indexleri yeniden olustur, search yap, data file counter=0, index file counter>0 kontrolu gerceklestir. Eger index file counter 0'dan buyukse, ariel index'leri dogru sekilde kullaniliyor demektir."
